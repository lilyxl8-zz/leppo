...
# c1 = Category.create(name: 'Web')
c4 = Category.create(name: 'Web')
c5 = Category.create(name: 'Urban')
c6 = Category.create(name: 'Destinations')
c8 = Category.create(name: 'Typography')
c9 = Category.create(name: 'Food')
# Home
c10 = Category.create(name: 'Designers')
# c2 = Category.create(name: 'Mobile')
# c3 = Category.create(name: 'Watch')
# c7 = Category.create(name: 'Wilderness')
